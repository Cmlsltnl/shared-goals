...
/***/ function(module, exports, __webpack_require__) {
	...
	var _goal = __webpack_require__(2);

	var _goal2 = _interopRequireDefault(_goal);

	var _site = __webpack_require__(34);
	...
	var Container = function Container(props) {
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(_goal2.default.Homer2, null)
	  );
	};
	...
	_reactDom2.default.render(_react2.default.createElement(
	  ...
	  _react2.default.createElement(_reactRouter.Route, { path: '/', component: _site2.default.Home }),
	  _react2.default.createElement(_reactRouter.Route, { path: '/by/:goal_slug/', component: _site2.default.Goal })
	...
	Goal.CardList = React.createClass({
	  ...
	  render: function render() {
	    var goalNodes = this.props.data.map(function (goal) {
	      return React.createElement(Goal.Card, { goal: goal, key: goal.pk });
	    });
	    return React.createElement(
	      'div',
	      { className: 'goalList' },
	...
	Goal.CardListBox = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      'div',
	      { className: 'goalsBox' },
	      React.createElement(Goal.CardList, { data: this.state.data })
	    );
	  }
	});

	Goal.Homer2 = function (props) {
	  return React.createElement(
	    'div',
	    { className: 'container' },
	    React.createElement(
	    ...
	    React.createElement(Goal.CardListBox, null)
	  );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	Site.Home = function (props) {
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(_goal2.default.CardListBox, null)
	  );
	};

	Site.Goal = function (props) {
	  return _react2.default.createElement(
	    'div',
	    { className: 'container' },
	    _react2.default.createElement(
	    ...
	    _react2.default.createElement(_suggestion2.default.CardGridBox, { url: 'api/suggestions/{this.props.goal_slug}' })
	  );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	Suggestion.Card = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        'a',
	        { href: this.props.suggestion.get_url },
	        React.createElement(
	          'div',
	          { className: 'suggestion--image', style: style },
	          React.createElement('div', { className: 'suggestion--gradient' }),
	          React.createElement(
	            'span',
	            { className: 'suggestion--title' },
	            React.createElement(
	              'span',
	              { className: 'suggestion--title--caption' },
	              this.props.suggestion.get_type_display,
	              ' ',
	              this.props.suggestion.stars
	            ),
	            React.createElement(
	              'h3',
	              null,
	              this.props.suggestion.current_revision.title
	            )
	          )
	        )
	      )
	...
	Suggestion.CardGrid = React.createClass({
	  ...
	  chunks: function chunks(items, chunkSize) {
	    var R = [];
	  ...
	  render: function render() {
	    var suggestionNodes = this.props.data.map(function (suggestion) {
	      return React.createElement(Suggestion.Card, { suggestion: suggestion, key: suggestion.pk });
	    });

	    var rows = this.chunks(suggestionNodes, 3).map(function (chunk, index) {
	      return React.createElement(
	        'div',
	        { className: 'row gap--small-above', key: index },
	        chunk
	      );
	    });
	...
	Suggestion.CardGridBox = React.createClass({
	  displayName: 'CardGridBox',

	  loadSuggestionsFromServer: function loadSuggestionsFromServer() {
	  ...
	  render: function render() {
	    return React.createElement(
	      'div',
	      { className: 'suggestion_CardGridBox' },
	      React.createElement(
	        'h1',
	        null,
	        'Suggestions'
	      ),
	      React.createElement(Suggestion.CardGrid, { data: this.state.data })
	    );
	  }
	});
